...
from zds.news.views import NewsList, NewsCreate, NewsUpdate, NewsDeleteDetail, NewsDeleteList, MessageNewsCreateUpdate
...
urlpatterns = patterns('',
                       ...
                       url(r'^message/creer/$', MessageNewsCreateUpdate.as_view(), name='news-message-create'),
)
