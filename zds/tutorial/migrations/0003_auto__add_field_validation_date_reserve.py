...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Validation.date_reserve'
        db.add_column(u'tutorial_validation', 'date_reserve',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Validation.date_reserve'
        db.delete_column(u'tutorial_validation', 'date_reserve')
