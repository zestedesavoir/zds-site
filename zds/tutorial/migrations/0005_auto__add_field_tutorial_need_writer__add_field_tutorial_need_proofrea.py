...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tutorial.need_writer'
        db.add_column(u'tutorial_tutorial', 'need_writer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Tutorial.need_proofreader'
        db.add_column(u'tutorial_tutorial', 'need_proofreader',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Tutorial.need_illustrator'
        db.add_column(u'tutorial_tutorial', 'need_illustrator',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Tutorial.need_newwriter'
        db.add_column(u'tutorial_tutorial', 'need_newwriter',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tutorial.need_writer'
        db.delete_column(u'tutorial_tutorial', 'need_writer')

        # Deleting field 'Tutorial.need_proofreader'
        db.delete_column(u'tutorial_tutorial', 'need_proofreader')

        # Deleting field 'Tutorial.need_illustrator'
        db.delete_column(u'tutorial_tutorial', 'need_illustrator')

        # Deleting field 'Tutorial.need_newwriter'
        db.delete_column(u'tutorial_tutorial', 'need_newwriter')
    ...
    models = {
        ...
        u'tutorial.tutorial': {
            ...
            'need_illustrator': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'need_newwriter': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'need_proofreader': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'need_writer': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
