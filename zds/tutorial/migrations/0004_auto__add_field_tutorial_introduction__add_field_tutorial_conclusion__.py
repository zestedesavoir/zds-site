...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tutorial.introduction'
        db.add_column(u'tutorial_tutorial', 'introduction',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tutorial.conclusion'
        db.add_column(u'tutorial_tutorial', 'conclusion',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tutorial.images'
        db.add_column(u'tutorial_tutorial', 'images',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Chapter.introduction'
        db.add_column(u'tutorial_chapter', 'introduction',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Chapter.conclusion'
        db.add_column(u'tutorial_chapter', 'conclusion',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Part.introduction'
        db.add_column(u'tutorial_part', 'introduction',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Part.conclusion'
        db.add_column(u'tutorial_part', 'conclusion',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Extract.text'
        db.add_column(u'tutorial_extract', 'text',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tutorial.introduction'
        db.delete_column(u'tutorial_tutorial', 'introduction')

        # Deleting field 'Tutorial.conclusion'
        db.delete_column(u'tutorial_tutorial', 'conclusion')

        # Deleting field 'Tutorial.images'
        db.delete_column(u'tutorial_tutorial', 'images')

        # Deleting field 'Chapter.introduction'
        db.delete_column(u'tutorial_chapter', 'introduction')

        # Deleting field 'Chapter.conclusion'
        db.delete_column(u'tutorial_chapter', 'conclusion')

        # Deleting field 'Part.introduction'
        db.delete_column(u'tutorial_part', 'introduction')

        # Deleting field 'Part.conclusion'
        db.delete_column(u'tutorial_part', 'conclusion')

        # Deleting field 'Extract.text'
        db.delete_column(u'tutorial_extract', 'text')
