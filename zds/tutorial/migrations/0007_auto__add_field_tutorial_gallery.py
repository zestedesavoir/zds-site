...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tutorial.gallery'
        db.add_column(u'tutorial_tutorial', 'gallery',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gallery.Gallery'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tutorial.gallery'
        db.delete_column(u'tutorial_tutorial', 'gallery_id')
