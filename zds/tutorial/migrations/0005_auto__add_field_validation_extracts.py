...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Validation.extracts'
        db.add_column(u'tutorial_validation', 'extracts',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Validation.extracts'
        db.delete_column(u'tutorial_validation', 'extracts')
    ...
    models = {
        ...
        u'tutorial.validation': {
            ...
            'extracts': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
