...
urlpatterns = patterns('',
                       ...
                       url(r'^editer/tutoriel/$',
                           'zds.tutorial.views.edit_tutorial'),
                       url(r'^modifier/tutoriel/$',
                           'zds.tutorial.views.modify_tutorial'),
                       url(r'^modifier/partie/$',
                           'zds.tutorial.views.modify_part'),
                       url(r'^editer/partie/$',
                           'zds.tutorial.views.edit_part'),
                       url(r'^modifier/chapitre/$',
                           'zds.tutorial.views.modify_chapter'),
                       url(r'^editer/chapitre/$',
                           'zds.tutorial.views.edit_chapter'),
                       url(r'^modifier/extrait/$',
                           'zds.tutorial.views.modify_extract'),
                       url(r'^editer/extrait/$',
                           'zds.tutorial.views.edit_extract'),

                       # Adding
                       url(r'^nouveau/tutoriel/$',
                           'zds.tutorial.views.add_tutorial'),
                       url(r'^nouveau/partie/$',
                           'zds.tutorial.views.add_part'),
                       url(r'^nouveau/chapitre/$',
                           'zds.tutorial.views.add_chapter'),
                       ...
                       url(r'^telecharger/pdf/$',
                           'zds.tutorial.views.download_pdf'),
                       url(r'^telecharger/html/$',
                           'zds.tutorial.views.download_html'),
                       url(r'^telecharger/epub/$',
                           'zds.tutorial.views.download_epub'),
                       url(r'^telecharger/md/$',
                           'zds.tutorial.views.download_markdown'),
