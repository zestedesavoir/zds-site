...
urlpatterns = [
    ...
    re_path(r'^(?P<pk_ptopic>[0-9]+)/messages/$',
            PrivatePostListAPI.as_view(), name='message-list'),
    re_path(r'^(?P<pk_ptopic>[0-9]+)/messages/(?P<pk>[0-9]+)/?$',
            PrivatePostDetailAPI.as_view(), name='message-detail'),
