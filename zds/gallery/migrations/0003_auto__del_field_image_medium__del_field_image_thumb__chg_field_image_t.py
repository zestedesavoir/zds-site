...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Image.medium'
        db.delete_column(u'gallery_image', 'medium')

        # Deleting field 'Image.thumb'
        db.delete_column(u'gallery_image', 'thumb')


        # Changing field 'Image.title'
        db.alter_column(u'gallery_image', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=80))

    def backwards(self, orm):
        # Adding field 'Image.medium'
        db.add_column(u'gallery_image', 'medium',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.thumb'
        db.add_column(u'gallery_image', 'thumb',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Image.title'
        db.alter_column(u'gallery_image', 'title', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))
