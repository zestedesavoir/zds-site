...
class ImageFormTest(TestCase):
    ...
    def test_valid_image_form(self):
        upload_file = open(os.path.join(settings.SITE_ROOT, 'fixtures', 'logo.png'), 'rb')
    ...
    def test_valid_archive_image_form(self):
        upload_file = open(os.path.join(settings.SITE_ROOT, 'fixtures', 'archive-gallery.zip'), 'rb')
    ...
    def test_too_big_pic_image_form(self):
        upload_file = open(os.path.join(settings.SITE_ROOT, 'fixtures', 'image_test.jpg'), 'rb')
    ...
    def test_bot_a_pic_image_form(self):
        upload_file = open(os.path.join(settings.SITE_ROOT, 'fixtures', 'forums.yaml'), 'rb')
