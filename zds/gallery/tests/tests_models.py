...
class GalleryTest(TestCase):
    ...
    def test_get_users_gallery(self):
        self.assertEqual(1, len(self.gallery.get_users_gallery()))
        self.assertEqual(self.user_gallery, self.gallery.get_users_gallery()[0])
