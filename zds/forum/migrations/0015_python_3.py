...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='category',
            name='slug',
            field=models.SlugField(help_text="Ces slugs vont provoquer des conflits d'URL et sont donc interdits : notifications resolution_alerte sujet sujets message messages", max_length=80, unique=True),
        ),
        migrations.AlterField(
            model_name='category',
            name='title',
        ...
        migrations.AlterField(
            model_name='post',
            name='topic',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='forum.Topic', verbose_name='Sujet'),
        ),
        migrations.AlterField(
            model_name='topic',
            name='author',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='topics', to=settings.AUTH_USER_MODEL, verbose_name='Auteur'),
        ),
        migrations.AlterField(
            model_name='topic',
            name='es_already_indexed',
        ...
        migrations.AlterField(
            model_name='topic',
            name='last_message',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='last_message', to='forum.Post', verbose_name='Dernier message'),
        ),
        migrations.AlterField(
            model_name='topic',
            name='pubdate',
