...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'forum_category', ['slug'])

        # Adding unique constraint on 'Forum', fields ['slug']
        db.create_unique(u'forum_forum', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Forum', fields ['slug']
        db.delete_unique(u'forum_forum', ['slug'])

        # Removing unique constraint on 'Category', fields ['slug']
        db.delete_unique(u'forum_category', ['slug'])
