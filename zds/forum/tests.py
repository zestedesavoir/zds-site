...
class ForumGuestTests(TestCase):
    ...
    def test_edit_main_post(self):
        ...
        self.assertNotEqual(Topic.objects.get(pk=topic1.pk).title, u'Un autre sujet')
        self.assertNotEqual(Topic.objects.get(pk=topic1.pk).subtitle, u'Encore ces lombards en plein été')
        self.assertNotEqual(Post.objects.get(pk=post1.pk).text, u'C\'est tout simplement l\'histoire de la ville de Paris que je voudrais vous conter ')
    ...
    def test_edit_post(self):
        ...
        self.assertEqual(result.status_code, 302)
        self.assertNotEqual(Post.objects.get(pk=post2.pk).text, u'C\'est tout simplement l\'histoire de la ville de Paris que je voudrais vous conter ')
