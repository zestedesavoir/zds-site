...
class UtilsTests(TestCase):
    ...
    def test_migrate_zep12(self):
        ...
        self.assertEqual(1, ContentRead.objects.filter(content=migrated_pulished_article).count(), 2)
        ...
        self.assertEqual(1, ContentRead.objects.filter(content=migrated_pulished_tuto).count(), 2)
