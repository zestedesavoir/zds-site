...
from zds.tutorialv2.forms import PublicationForm, RevokeValidationForm, DoNotPickOpinionForm, PickOpinionForm, \
    UnpickOpinionForm, PromoteOpinionToArticleForm
