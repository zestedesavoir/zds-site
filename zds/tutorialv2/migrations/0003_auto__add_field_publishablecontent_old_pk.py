...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PublishableContent.old_pk'
        db.add_column(u'tutorialv2_publishablecontent', 'old_pk',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PublishableContent.old_pk'
        db.delete_column(u'tutorialv2_publishablecontent', 'old_pk')
    ...
    models = {
        ...
        u'tutorialv2.publishablecontent': {
            ...
            'old_pk': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
