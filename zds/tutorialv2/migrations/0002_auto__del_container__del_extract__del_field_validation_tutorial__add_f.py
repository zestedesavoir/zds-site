...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Validation.tutorial'
        db.delete_column(u'tutorialv2_validation', 'tutorial_id')

        # Adding field 'Validation.content'
        db.add_column(u'tutorialv2_validation', 'content',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tutorialv2.PublishableContent'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PublishableContent.container_ptr'
        db.delete_column(u'tutorialv2_publishablecontent', u'container_ptr_id')

        # Deleting field 'PublishableContent.images'
        db.delete_column(u'tutorialv2_publishablecontent', 'images')

        # Adding field 'PublishableContent.id'
        db.add_column(u'tutorialv2_publishablecontent', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True),
                      keep_default=False)

        # Adding field 'PublishableContent.title'
        db.add_column(u'tutorialv2_publishablecontent', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80),
                      keep_default=False)

        # Adding field 'PublishableContent.relative_images_path'
        db.add_column(u'tutorialv2_publishablecontent', 'relative_images_path',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ContentRead.tutorial'
        db.delete_column(u'tutorialv2_contentread', 'tutorial_id')

        # Adding field 'ContentRead.content'
        db.add_column(u'tutorialv2_contentread', 'content',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['tutorialv2.PublishableContent']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Validation.tutorial'
        db.add_column(u'tutorialv2_validation', 'tutorial',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tutorialv2.PublishableContent'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Validation.content'
        db.delete_column(u'tutorialv2_validation', 'content_id')


        # User chose to not deal with backwards NULL issues for 'PublishableContent.container_ptr'
        raise RuntimeError("Cannot reverse this migration. 'PublishableContent.container_ptr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PublishableContent.container_ptr'
        db.add_column(u'tutorialv2_publishablecontent', u'container_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tutorialv2.Container'], unique=True, primary_key=True),
                      keep_default=False)

        # Adding field 'PublishableContent.images'
        db.add_column(u'tutorialv2_publishablecontent', 'images',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PublishableContent.id'
        db.delete_column(u'tutorialv2_publishablecontent', u'id')

        # Deleting field 'PublishableContent.title'
        db.delete_column(u'tutorialv2_publishablecontent', 'title')

        # Deleting field 'PublishableContent.relative_images_path'
        db.delete_column(u'tutorialv2_publishablecontent', 'relative_images_path')


        # User chose to not deal with backwards NULL issues for 'ContentRead.tutorial'
        raise RuntimeError("Cannot reverse this migration. 'ContentRead.tutorial' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ContentRead.tutorial'
        db.add_column(u'tutorialv2_contentread', 'tutorial',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tutorialv2.PublishableContent']),
                      keep_default=False)

        # Deleting field 'ContentRead.content'
        db.delete_column(u'tutorialv2_contentread', 'content_id')
