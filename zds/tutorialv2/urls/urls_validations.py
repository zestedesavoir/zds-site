...
urlpatterns = [
                       ...
                       url(r'^annuler/(?P<pk>\d+)/$', CancelValidation.as_view(),
                           name="cancel"),
                       url(r'^reserver/(?P<pk>\d+)/$', ReserveValidation.as_view(),
                           name="reserve"),
                       url(r'^refuser/(?P<pk>\d+)/$', RejectValidation.as_view(),
                           name="reject"),
                       url(r'^accepter/(?P<pk>\d+)/$', AcceptValidation.as_view(),
                           name="accept"),
