...
urlpatterns = [
    ...
    url(r'^nosplit/(?P<pk>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/(?P<container_slug>[a-zA-Z0-9_-]+)/$',
        DisplayContainer.as_view(public_is_prioritary=False, template_name='tutorialv2/view/container_nosplit.html'),
        name='view-container-nosplit'),
    url(r'^nosplit/(?P<pk>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/'
        r'(?P<parent_container_slug>[a-zA-Z0-9_-]+)/(?P<container_slug>[a-zA-Z0-9_-]+)/$',
        DisplayContainer.as_view(public_is_prioritary=False, template_name='tutorialv2/view/container_nosplit.html'),
        name='view-container-nosplit'),
    url(r'^nosplit/(?P<pk>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/$',
        DisplayContent.as_view(public_is_prioritary=False, template_name='tutorialv2/view/content_nosplit.html'),
        name='view-nosplit'),
    url(r'^(?P<pk>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/(?P<parent_container_slug>.+)/(?P<container_slug>.+)/$',
        DisplayContainer.as_view(public_is_prioritary=False),
        name='view-container'),
    url(r'^(?P<pk>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/(?P<container_slug>.+)/$',
        DisplayContainer.as_view(public_is_prioritary=False),
        name='view-container'),

    url(r'^(?P<pk>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/$', DisplayContent.as_view(public_is_prioritary=False),
        name='view'),
