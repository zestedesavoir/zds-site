...
urlpatterns = [
    ...
    re_path(r'^ajouter-relecteur/(?P<pk>\d+)/$',
            AddProofreaderToContent.as_view(), name='add-proofreader'),
    re_path(r'^enlever-relecteur/(?P<pk>\d+)/$',
            RemoveProofreaderFromContent.as_view(), name='remove-proofreader'),
    # beta:
