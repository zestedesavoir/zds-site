...
class Source(models.Model, Dimension):
    ...
    code = models.CharField(u'Source', max_length=80, null=True, db_index=True)
...
class Country(models.Model, Dimension):
    ...
    code = models.CharField(u'Pays', max_length=80, null=True, db_index=True)
...
class City(models.Model, Dimension):
    ...
    code = models.CharField(u'Ville', max_length=80, null=True, db_index=True)
...
class OS(models.Model, Dimension):
    ...
    code = models.CharField(u'Système d\'exploitaiton', max_length=80, null=True, db_index=True)
...
class Browser(models.Model, Dimension):
    ...
    code = models.CharField(u'Navigateur', max_length=80, null=True, db_index=True)
...
class Device(models.Model, Dimension):
    ...
    code = models.CharField(u'Device', max_length=80, null=True, db_index=True)
...
class Log(models.Model):
    ...
    hash_code = models.CharField('Hash code de la ligne de log', max_length=32, null=True)
    ...
    os_family = models.CharField('Famille de systeme d\'exploitation', max_length=30, null=True, db_index=True)
    os_version = models.CharField('Version du systeme d\'exploitation', max_length=15, null=True)
    browser_family = models.CharField('Famille du navigateur', max_length=20, null=True, db_index=True)
    ...
    country = models.CharField('Pays', max_length=40, null=True, db_index=True)
    city = models.CharField('Ville', max_length=40, null=True, db_index=True)
