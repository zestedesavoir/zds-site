...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SubCategory.category'
        db.delete_column(u'utils_subcategory', 'category_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'SubCategory.category'
        db.add_column(u'utils_subcategory', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['utils.Category']),
                      keep_default=False)
