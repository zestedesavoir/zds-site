...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field group on 'SubCategory'
        m2m_table_name = db.shorten_name(u'utils_subcategory_group')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('subcategory', models.ForeignKey(orm[u'utils.subcategory'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['subcategory_id', 'group_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field group on 'SubCategory'
        db.delete_table(db.shorten_name(u'utils_subcategory_group'))
