...
urlpatterns = patterns('',
                       ...
                       url(r'^flux/rss/$',
                           feeds.LastArticlesFeedRSS(),
                           name='article-feed-rss'),
                       ...
                       url(r'^resolution_alerte/$',
                           'zds.article.views.solve_alert'),

                       url(r'^voir/(?P<article_pk>\d+)/(?P<article_slug>.+)/$',
                           'zds.article.views.deprecated_view_redirect'),
                       url(r'^off/(?P<article_pk>\d+)/(?P<article_slug>.+)/$',
                           'zds.article.views.view'),
                       url(r'^(?P<article_pk>\d+)/(?P<article_slug>.+)/$',
                           'zds.article.views.view_online'),
                       url(r'^(?P<article_pk>\d+)/(?P<article_slug>.+)/reactions$',
                           'zds.article.views.redirect_reactions'),
                       ...
                       url(r'^historique/(?P<article_pk>\d+)/(?P<article_slug>.+)/$',
                           'zds.article.views.history'),

                       # Validation
                       url(r'^validation/$',
                           'zds.article.views.list_validation'),
