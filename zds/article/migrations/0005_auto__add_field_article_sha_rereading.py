...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.sha_rereading'
        db.add_column(u'article_article', 'sha_rereading',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.sha_rereading'
        db.delete_column(u'article_article', 'sha_rereading')
    ...
    models = {
        u'article.article': {
            ...
            'sha_rereading': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
