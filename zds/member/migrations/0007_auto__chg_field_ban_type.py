...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ban.type'
        db.alter_column(u'member_ban', 'type', self.gf('django.db.models.fields.CharField')(max_length=80))

    def backwards(self, orm):

        # Changing field 'Ban.type'
        db.alter_column(u'member_ban', 'type', self.gf('django.db.models.fields.CharField')(max_length=15))
