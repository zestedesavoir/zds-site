...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'member_tokenforgotpassword', (
            ...
            ('token', self.gf('django.db.models.fields.CharField')(default='deae521f-e6e8-4f8e-b312-e499f31838d6', max_length=100)),
            ('date_end', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'member.tokenforgotpassword': {
            ...
            'date_end': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'1000944d-ba14-4004-849d-bec8ec3b66f9'", 'max_length': '100'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
