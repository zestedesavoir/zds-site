...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TokenForgotPassword.date_end'
        db.alter_column(u'member_tokenforgotpassword', 'date_end', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'TokenForgotPassword.date_end'
        db.alter_column(u'member_tokenforgotpassword', 'date_end', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
