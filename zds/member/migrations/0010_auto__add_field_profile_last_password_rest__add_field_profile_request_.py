...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.last_password_reset'
        db.add_column(u'member_profile', 'last_password_reset',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.request_password_reset'
        db.add_column(u'member_profile', 'request_password_reset',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.last_password_reset'
        db.delete_column(u'member_profile', 'last_password_reset')

        # Deleting field 'Profile.request_password_reset'
        db.delete_column(u'member_profile', 'request_password_reset')
    ...
    models = {
        ...
        u'member.profile': {
            ...
            'last_password_reset': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'last_visit': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'request_password_reset': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
