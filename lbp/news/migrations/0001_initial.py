...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AlertNews'
        db.create_table(u'news_alertnews', (
            (u'alert_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['utils.Alert'], unique=True, primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['news.Comment'], null=True, blank=True)),
        ))
        db.send_create_signal(u'news', ['AlertNews'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AlertNews'
        db.delete_table(u'news_alertnews')
    ...
    models = {
        ...
        u'news.alertnews': {
            'Meta': {'ordering': "('-pubdate',)", 'object_name': 'AlertNews', '_ormbases': [u'utils.Alert']},
            u'alert_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['utils.Alert']", 'unique': 'True', 'primary_key': 'True'}),
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['news.Comment']", 'null': 'True', 'blank': 'True'})
        },
        u'news.comment': {
