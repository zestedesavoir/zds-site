...
from lbp.gallery.models import UserGallery, Image, Gallery
from lbp.gallery.forms import ImageForm, GalleryForm, UserGalleryForm
...
def modify_gallery(request):
    ...
    if 'delete_multi' in request.POST:
        ...
        return redirect(reverse('lbp.gallery.views.gallery_list'))
