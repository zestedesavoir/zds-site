...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field criterias on 'Category'
        m2m_table_name = db.shorten_name(u'project_category_criterias')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('category', models.ForeignKey(orm[u'project.category'], null=False)),
            ('criteria', models.ForeignKey(orm[u'project.criteria'], null=False))
        ))
        db.create_unique(m2m_table_name, ['category_id', 'criteria_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field criterias on 'Category'
        db.delete_table(db.shorten_name(u'project_category_criterias'))
    ...
    models = {
        ...
        u'project.project': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'projets+'", 'blank': 'True', 'to': u"orm['project.Category']"}),
