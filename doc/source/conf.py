...
copyright = '2014-{}, {}'.format(now.year, project)
...
latex_documents = [
    (master_doc, 'ZestedeSavoir.tex', 'Zeste de Savoir Documentation',
     'Contributeurs de Zeste de Savoir', 'manual'),
]
...
man_pages = [
    (master_doc, 'zestedesavoir', 'Zeste de Savoir Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ZestedeSavoir', 'Zeste de Savoir Documentation',
     author, 'ZestedeSavoir', 'One line description of project.',
     'Miscellaneous'),
]
